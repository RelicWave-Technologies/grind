...
export default function EditTime() {
  ...
  /**
   * The backend now emits gaps over the entire day (clipped at `now` for
   * today), so we don't synthesize them client-side anymore. This memo is
   * a passthrough kept for the dayData fallback below.
   */
  const effectiveDay = day.data;
