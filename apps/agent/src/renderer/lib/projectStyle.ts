import { Monitor, Code2, BookOpen, Dumbbell, Briefcase, Rocket, type LucideIcon } from 'lucide-react';
...
const PALETTE: ProjectStyle[] = [
  ...
  { color: 'var(--c-blue)', tagBg: 'var(--c-blue-bg)', tagFg: 'var(--c-blue)', icon: Briefcase },
